            ...
            <div className='my-content px-3'>
                ...
                <div className='mt-4'>
                    ...
                    <div className='d-flex mt-2 fs-5 fw-medium bg-white border text-secondary'>
                        <div className={`py-3 w-100 d-flex justify-content-center align-items-center ${!showSale ? 'checked' : ''}`} onClick={() => saleClick(false)}>
                            <span>없음</span>
                        </div>

                        <div className={`py-3 w-100 d-flex justify-content-center align-items-center ${showSale ? 'checked' : ''}`} onClick={() => saleClick(true)}>
                            <span>입력</span>
                        </div>
                    </div>
                ...
                <div className='mt-4'>
                    ...
                    <div className='d-flex mt-2 fs-5 fw-medium bg-white border text-secondary align-items-center'>

                        <div className={`py-3 w-50 d-flex justify-content-center align-items-center ${pay === 'card' ? 'checked' : ''}`} onClick={() => setPay('card')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-credit-card me-2" viewBox="0 0 16 16">
                        ...
                        <div div className={`py-3 w-50 d-flex justify-content-center align-items-center ${pay === 'cash' ? 'checked' : ''}`} onClick={() => setPay('cash')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-cash-coin me-2" viewBox="0 0 16 16">
                            ...
                            <Accordion.Item eventKey='0'>
                                <Accordion.Header>
                                    <div className='fw-semibold text-secondary d-flex align-items-center'>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calculator ms-2" viewBox="0 0 16 16">
